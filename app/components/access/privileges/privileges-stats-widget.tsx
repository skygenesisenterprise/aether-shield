...
export function PrivilegesStatsWidget() {
  const stats = [
    { label: "Total Privileges", value: "24", icon: Shield },
    { label: "Active Privileges", value: "18", icon: Shield },
    { label: "System Privileges", value: "8", icon: Shield },
    { label: "User Privileges", value: "16", icon: Shield },
  ];
